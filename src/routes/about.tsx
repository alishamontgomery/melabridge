...
export const Route = createFileRoute("/about")({
  ...
  component: () => (
    ...
    >
      <h2>Our story</h2>
      <p>We started MelaBridge after planning one too many weddings, birthdays, and community celebrations across a dozen disconnected tools — checklists in one app, budgets in another, guest lists in a spreadsheet, vendor contracts buried in email. There had to be a calmer way.</p>
      ...
      <ul>
        ...
        <li><strong>AI should ask, not act.</strong> Every draft, every message, every booking waits for your approval. You always hold the pen.</li>
        <li><strong>Personal planning should be free.</strong> Families shouldn't pay per RSVP or lose a cut of donations. We charge businesses running a business, not families running a celebration.</li>
      ...
      <p>Hosts and families planning weddings, birthdays, anniversaries, and reunions. Professional planners running many events for many clients. Vendors who want to be discovered and book more work. Community organizers and nonprofits running fundraisers, galas, and gatherings.</p>
