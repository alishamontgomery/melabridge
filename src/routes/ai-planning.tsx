...
export const Route = createFileRoute("/ai-planning")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Meet Bridge Concierge™, BridgeMind™, and the AI systems that plan your event in minutes." },
  ...
  component: () => (
    <MarketingPage
      ...
      description="Bridge Concierge™ guides you through a natural conversation, then autonomously builds your timeline, budget, guest strategy, and vendor shortlist."
    >
      <h2>Bridge Concierge™</h2>
