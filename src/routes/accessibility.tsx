...
export const Route = createFileRoute("/accessibility")({
  ...
  component: () => (
    ...
    >
      ...
      <h2>Feedback</h2>
      <p>If you encounter an accessibility barrier, please email <a href="mailto:hello@melabridge.com">hello@melabridge.com</a> and we'll respond within two business days.</p>
    </MarketingPage>
  ),
});
